...
def get_profile():
    try:
        ...
        cursor = db.cursor(dictionary=True)
        user_id = request.user['user_id']  # From token_required decorator
...
If it is not, respond with: "Sorry, this question is outside the scope of {category} products."

Below is a full conversation between the user and assistant. Stay consistent and context-aware in your reply.

{chat_log}

Context documents to help you answer:
{context}
